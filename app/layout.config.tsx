...
import Logo from '@/public/favicon/icon-512.png';
...
export const linkItems: LinkItemType[] = [
  ...
  {
    type: 'icon',
    url: 'https://github.com/silverthreadlabs/bloggen-saas-starter-better-auth',
    text: 'Github',
    icon: (
...
export const logo = (
  <>
    <Image
      alt="Silverthreadlabs"
      src={Logo}
      sizes="100px"
      className="hidden w-20 md:w-24 [.uwu_&]:block"
      aria-label="Silverthreadlabs"
    />
